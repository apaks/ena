...
while True:
    ...
    if capture.isOpened():
        ...
        capture.set(cv2.CAP_PROP_FRAME_HEIGHT, 100) #Check obj analysis crop for changing x,y
    ...
    if len(buf) > 0: #If any data is received
        ...
        #fourcc=cv.CV_FOURCC(*'X264'),
                                ...
                                frameSize=(160, 100)) # MUST MATCH CAPTURE
        ...
        for i in range(240): #total frames captured, captured at rate listed above (supposedly) (20 frames per second? 1/20 * 80 = 4.0s.  May not always be perfectly coordinated w recording time, but should be most of the time

  ...
  // put your main code here, to run repeatedly:
    if (Serial.available()>0){
      if (Serial.read()=='1'){
        ...
        delay(10); //the amount of time the light is off (milliseconds)
        for (int ii = 1; ii <= 2 ; ii++){
       
          for (int i =1 ; i <= 20 ; i++){//90 for 3s 600 for 20s, 900 for 30s, 9,000 for 5min
            digitalWrite(3,HIGH);
            delay(40); // the amount of time the light is on (milliseconds)  
            digitalWrite(3,LOW);
            delay(40);}

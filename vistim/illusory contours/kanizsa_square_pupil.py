...
square_small = visual.Rect(myWin, width=225, 
            height=225, fillColor='grey', 
            lineColor=None)
...
core.wait(4)
for i, val in enumerate(trial_seq):
    val = 1
    square.opacity = 1
    if val == 4:
...
#        t2 = time.time() 
#    print t2 -t1
    core.wait(1)  #waits for 5 seconds
